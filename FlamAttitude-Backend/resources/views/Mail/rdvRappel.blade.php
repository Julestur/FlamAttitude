...
<body style="font-family: Arial, sans-serif;">
    ...
    <p>Petit rappel : vous avez un rendez-vous <strong>{{ $delaiLabel }}</strong> :</p>
    ...
    <p>Si vous devez annuler ou reprogrammer, connectez-vous à votre espace Flam'Attitude.</p>
</body>
</html>
